<template>
  <el-dialog v-model="visible" title="编辑视频" width="700px" :close-on-click-modal="false">
...
watch(() => props.modelValue, (val) => {
  ...
  if (val && props.video) {
    ...
    form.cover_preview = props.video.cover_url ? resolveFileUrl(props.video.cover_url) : ''
